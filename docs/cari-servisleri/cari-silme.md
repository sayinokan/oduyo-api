...
<table><thead><tr><th width="177.3097476496784">HTTP Metod</th><th width="569.4285714285713">URL</th></tr></thead><tbody><tr><td><mark style="color:green;"><code>POST</code></mark></td><td><mark style="color:red;"><code>https://www.siteadi.com/api/v1/customer/customer_delete</code></mark></td></tr></tbody></table>
...
<mark style="color:green;">`POST`</mark> `https://www.siteadi.com/api/v1/customer/customer_delete`

Ödüyo içerisine gönderilen cari kaydını siler.
