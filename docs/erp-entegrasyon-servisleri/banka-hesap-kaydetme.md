---
description: >-
  ERP banka hesaplarının Ödüyo banka hesaplarıyla eşleştirilebilmesi için,
  ilgili banka hesaplarının sisteme kaydedilme işlemi için kullanılan endpoint
  ve http metod bilgisi aşağıda verilmiştir.
---

# Banka Hesap Kaydetme

öURL

<table><thead><tr><th width="149.40234375">HTTP Metod</th><th></th></tr></thead><tbody><tr><td>POST</td><td>https://www.siteadi.com/api/v1/erp/erp_bank_account/create</td></tr></tbody></table>
...
=== "200"
    ...
    {
        "status": true,
        "data": "Erp Bank Account successfully added id"
    }
    ```
