---
description: >-
  ERP sisteminde kayıtlı olan Hizmet giderlerinin, Ödüyo sistemine kaydedilmesi
  için kullanılan endpoint ve HTTP metod bilgisi aşağıda verilmiştir.
---

# Hizmet Giderleri Kaydetme

öURL

<table><thead><tr><th width="149.40234375">HTTP Metod</th><th></th></tr></thead><tbody><tr><td>POST</td><td>https://www.siteadi.com/api/v1/erp/erp_services/create</td></tr></tbody></table>
...
=== "200"
    ...
    {
        "status": true,
        "data": "Erp Service successfully added id <1>"
    }
    ```
=== "404"
    ```
