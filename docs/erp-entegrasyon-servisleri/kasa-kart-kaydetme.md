---
description: >-
  ERP sisteminde kayıtlı olan kasa kartlarının, Ödüyo sistemine kaydedilmesi
...
<table><thead><tr><th width="149.40234375">HTTP Metod</th><th></th></tr></thead><tbody><tr><td>POST</td><td>https://www.siteadi.com/api/v1/erp/erp_kasa_fisi/create</td></tr></tbody></table>
...
=== "200"
    ...
    {
        "status": true,
        "data": "Erp Kasa Fisi successfully added id <1>"
    }
    ```
