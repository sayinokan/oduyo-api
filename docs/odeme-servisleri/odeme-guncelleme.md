---
description: >-
  Çekim işlemleri güncelleme işlemi için kullanılan endpoint ve http metod
...
<table><thead><tr><th width="150">HTTP Metod</th><th width="523.4285714285713">URL</th></tr></thead><tbody><tr><td><mark style="color:green;"><code>POST</code></mark></td><td><a href="https://www.siteadi.com/api/v1/payment/payment_update"><mark style="color:red;"><code>https://www.siteadi.com/api/v1/payment/payment_update</code></mark></a></td></tr></tbody></table>
...
<mark style="color:green;">`POST`</mark> `https://www.siteadi.com/api/v1/payment/payment_update`

Ödüyo içerisine gönderilen çekim işlemlerini günceller.
...
| Name                                                | Type              | Description                                                        |
| --------------------------------------------------- | ----------------- | ------------------------------------------------------------------ |
| period\_order<mark style="color:red;">\*</mark>     | string            | Periyodik ödeme                                                    |
...
| collection\_sms<mark style="color:red;">\*</mark>   | string            | Tahsilat makbuzu sms gönderimi("1"=gönderildi,"0"=gönderilmedi)    |
| collection\_email<mark style="color:red;">\*</mark> | string            | Tahsilat makbuzu e-mail gönderimi("1"=gönderildi,"0"=gönderilmedi) |
| paymentsend\_id                                     | numeric(int)      | Ödeme gönderim numarası                                            |
| customer\_id                                        |                   | Ödeme yapan müşteri için tutulan pk id                             |
| orderid                                             | String            | Sipariş numarası                                                   |
| installment\_number                                 |                   | Taksit sayısı                                                      |
| plus\_installment                                   |                   | Artı taksit sayısı                                                 |
| status                                              | String            | Ödeme durumu                                                       |
| masked\_card                                        | String            | Kart numarası                                                      |
| total\_with\_commison                               | numeric(decimal)) | Komisyonlu toplam tutar                                            |
| total\_without\_commison                            | numeric(decimal)  | Komisyonsuz toplam tutar                                           |
...
| payment\_address                                    | string            | Müşteri adresi                                                     |
