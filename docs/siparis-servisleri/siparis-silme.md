---
description: >-
  Sipariş silme işlemi için kullanılan endpoint ve http metod bilgisi aşağıda
  verilmiştir
---
...
<table><thead><tr><th width="177.3097476496784">HTTP Metod</th><th width="569.4285714285713">URL</th></tr></thead><tbody><tr><td><mark style="color:green;"><code>POST</code></mark></td><td><mark style="color:red;"><code>https://www.siteadi.com/api/v1/order/order_delete</code></mark></td></tr></tbody></table>

### <mark style="color:blue;">İşlem Parametreleri</mark> <a href="#url" id="url"></a>

Sipariş silme işlemi için isteklerde gönderilmesi beklenen parametreler ve sorgu örneği aşağıda belirtilmiştir.
...
<mark style="color:green;">`POST`</mark> `https://www.siteadi.com/api/v1/order/order_delete`

Ödüyo içerisine gönderilen sipariş kaydını siler.
